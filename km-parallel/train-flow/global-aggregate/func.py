...
def handler(ctx, data=None, loop=None):
    if data and len(data) > 0:
        ...
        model_object_name = model_object_prefix_name + '/final/final_model.pkl'
        ...
        minio_get_all_objects(minio_client, model_object_bucket_name, model_object_prefix_name + '/local',
                              '/tmp/model', logger)
